...
#CLI
# 기본 예시 ─ 필수 인자만 지정
python amodal_pipeline.py  --input_dir ~/volum1/cy/latent-code-inpainting_new/data/data_large/test_256 --max_images 10  --output_dir ~/volum1/cy/pix2gestalt/results/amodal_dataset1  --num_gpus 6         
